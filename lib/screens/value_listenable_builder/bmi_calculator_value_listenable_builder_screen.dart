...
class BmiCalculatorValueListenableScreen extends StatelessWidget {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            _buildHeightWidget(heightNotifier),
            SizedBox(height: 23),
  ...
  Widget _buildAgeWidget(ValueNotifier<int> ageNotifier) {
  ...
  Widget _buildWeightWidget(ValueNotifier<int> weightNotifier) {
    return ValueListenableBuilder<int>(
  ...
  Widget _buildHeightWidget(ValueNotifier<int> heightNotifier) {
    return ValueListenableBuilder<int>(
  ...
  Widget _buildGenderWidget(ValueNotifier<bool> isMaleNotifier) {
