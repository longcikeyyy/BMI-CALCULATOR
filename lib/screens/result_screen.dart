          ...
          children:[
            ...
            Container(
              ...
              child: Column(
                children:[
                  Text("BMI Results",
                  style:AppTextstyle.tsRegularSize28Navi.copyWith(fontSize:32)),
                  Text.rich(
                   TextSpan(
                    children:[
                     TextSpan(
                      text: bmi?.toStringAsFixed(2).split('.')[0] ?? '0',  // 22
                      style: AppTextstyle.tsBoldSize58Navi.copyWith(fontSize:141)),
                     TextSpan(
                      text: '.${bmi?.toStringAsFixed(2).split('.')[1] ?? '0'}',  // .54
                      style: AppTextstyle.tsBoldSize58Navi.copyWith(fontSize:43)),
        ],
  ),
),
                  Text(
                  ...
                  SizedBox(height:18),
                  Center(child: Text("Underweight: BMI less than 18.5\nNormal weight: BMI 18.5 to 24.9\nOverweight: BMI 25 to 29.9\nObesity: BMI 30 to 40",
                  style:AppTextstyle.tsMediumSize24Navi.copyWith(fontSize:13),
